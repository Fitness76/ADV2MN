...
#
# Usage:
# bash ADV2_Masternode_setup_ipv4.sh [Masternode_Private_Key]
#
# Example 1: Existing genkey created earlier is supplied
# bash ADV2_Masternode_setup_ipv4.sh 64uMMRs91QP3iVufzawi81HSBky8WuHxpxL3ZTuTH96BxhLkBZN
#
# Example 2: Script will generate a new genkey automatically
# bash ADV2_Masternode_setup_ipv4.sh
#
...
for your Hot Wallet (the wallet with your ADV2 collateral funds):
======================================================================== \a"
